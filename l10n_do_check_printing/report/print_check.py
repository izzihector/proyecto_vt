...
class PrintCheck(models.AbstractModel):
    ...
    def _get_report_values(self, docids, data=None):
        ...
        payments = []
        for payment in docs: # _ids:
            #payment.payment_date
            year = str(payment.payment_date.year)
            month = str(payment.payment_date.month).zfill(2)
            day = str(payment.payment_date.day).zfill(2)
            payment.report_date = "{} {} {} {} {} {} {} {}".format(day[0], 
                    day[1], month[0], month[1], year[0], year[1], year[2],
                    year[3])
